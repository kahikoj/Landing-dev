                            ...
                            <CardBody>
                                ...
                                <div className="widget mb-4 pb-2">
                                    ...
                                    <div className="tagcloud mt-4">
                                        ...
                                        <Link to="#" className="rounded ml-1">Finance</Link>
                                        <Link to="#" className="rounded ml-1">Marketing</Link>
                                        <Link to="#" className="rounded">Fashion</Link>
                                        <Link to="#" className="rounded ml-1">Bride</Link>
                                        <Link to="#" className="rounded ml-1">Lifestyle</Link>
                                        <Link to="#" className="rounded">Travel</Link>
                                        <Link to="#" className="rounded ml-1">Beauty</Link>
                                        <Link to="#" className="rounded ml-1">Video</Link>
                                        <Link to="#" className="rounded ml-1">Audio</Link>
                                    </div>
                                </div>
