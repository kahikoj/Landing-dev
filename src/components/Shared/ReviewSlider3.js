                                ...
                                <Row>
                                    ...
                                    this.state.step1 === true ?
                                        ...
                                        <Col key={key} md={this.state.cols} className="mb-1">
                                            <Card key={key} className={ this.props.isBgWhite ? "customer-testi m-2 text-center rounded shadow border-0" : "customer-testi text-center"}>
                                                <CardBody>
                                                <p className="text-muted h6 font-italic">" {client.desc} "</p>
                                                <img src={client.image} style={{height:65, width:65}} className={this.props.isBgWhite ? "img-fluid avatar avatar-small mt-3 rounded-circle mx-auto shadow mb-1" : "mb-1 img-fluid avatar avatar-small mt-3 rounded-circle mx-auto shadow"} alt=""/>
                                                <br/>
                                                <StarRatings
                                        ...
                                        <Col key={key} md={this.state.cols} className="mb-1">
                                            <Card key={key} className={ this.props.isBgWhite ? "customer-testi m-2 text-center rounded shadow border-0" : "customer-testi text-center"}>
                                                <CardBody>
                                                <p className="text-muted h6 font-italic">" {client.desc} "</p>
                                                <img src={client.image} style={{height:65, width:65}} className={this.props.isBgWhite ? "img-fluid avatar avatar-small mt-3 rounded-circle mx-auto shadow mb-1" : "img-fluid avatar avatar-small mt-3 rounded-circle mx-auto shadow mb-1"} alt=""/>
                                                <br/>
                                                <StarRatings
                                                    rating={client.rating}
                                                    starRatedColor="#F17425"
