                                    ...
                                    <Col lg={7} md={7}>
                                        <div className="title-heading mt-4">
                                            ...
                                            <div className="watch-video mt-4 pt-2">
                                                ...
                                                <Link  onClick={this.openModal} to="#" className="video-play-icon watch text-dark mb-2 ml-1"><i className="mdi mdi-play play-icon-circle text-center d-inline-block mr-2 rounded-pill title-dark text-white position-relative play play-iconbar"></i> WATCH VIDEO</Link>
