...
import online from "../../assets/images/icon/online-payment.svg";
import payment from "../../assets/images/icon/payment.svg";
                            ...
                            <div className="mt-4">
                                {
                                    this.state.paymentMethods.map((paymentMethod, key) =>
                                        <Link to="" key={key}>
                                            <img src={paymentMethod.icon} className="img-fluid avatar avatar-small mx-2 mt-4 rounded-circle shadow" id={paymentMethod.id} alt=""/>
