                        ...
                        <Row className="justify-content-center">
                            ...
                            <div className="section-title">
                                ...
                                <div className="contact-detail mt-5">
                                    ...
                                    <a href="https://1.envato.market/landrickreactjs" target="_blank" rel="noopener noreferrer" className="btn btn-primary mt-3">Get Started <Badge pill color="danger" className="ml-2">v2.0</Badge></a>
                                </div>
                            </Col>
                        </Row>
                    </Container>
