...
import { Container, Row, Col, Form, Alert, Input, FormGroup, Label, Card, CardBody } from "reactstrap";
                        ...
                        <Col lg="5" md="6" xs="12" className="mt-4 pt-2">
                            <Card className="bg-light shadow rounded border-0">
                                <div className="bg-primary p-4 text-center rounded-top">
                                    <h4 className="mb-0 card-title title-dark text-light">Payment plan</h4>
                                </div>
                                ...
                                <CardBody>
                                    ...
                                    <ul className="feature list-inline">
                                        <li className="h5 font-weight-normal"><i><FeatherIcon icon="check-circle" className="fea icon-ex-md text-primary mr-2" /></i>Transparent payouts</li>
                                        <li className="h5 font-weight-normal"><i><FeatherIcon icon="check-circle" className="fea icon-ex-md text-primary mr-2" /></i>Deposit tagging</li>
                                        <li className="h5 font-weight-normal"><i><FeatherIcon icon="check-circle" className="fea icon-ex-md text-primary mr-2" /></i>Control payout timing</li>
                                        <li className="h5 font-weight-normal"><i><FeatherIcon icon="check-circle" className="fea icon-ex-md text-primary mr-2" /></i>24×7 support</li>
                                    </ul>
