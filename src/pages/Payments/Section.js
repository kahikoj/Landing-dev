...
import { Container, Row, Col, Form, Alert, Input, Button, FormGroup, InputGroup, InputGroupAddon, Card, CardBody } from "reactstrap";
                        ...
                        <Row className="justify-content-center">
                            <Col lg="10">
                                <div className="title-heading text-center mt-4">
                                    ...
                                    <h6 className="text-primary mt-3 font-weight-bold">PAYMENTS</h6>
