                            ...
                            <Col md="6" className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                                ...
                                <div className="progress-box">
                                        ...
                                        <div className="progress-box mt-4">
                                            ...
                                            <Progress value={93} color="primary" barClassName="position-relative">
                    ...
                    <Container className="mt-100 mt-60" id="portfolio">
                        ...
                        <Row>
                                ...
                                this.state.projects.map((project, key) =>
                                    <Col lg="4" md="6" key={key} className="mt-4 pt-2">
                                        <Card className="border-0 work-container work-modern position-relative d-block overflow-hidden rounded">
                                            ...
                                            <img src={project.image} className="img-fluid" alt="work" />
                                            <div className="overlay-work bg-dark"></div>
                                            <div className="content">
                                                <h5 className="mb-0"><Link to="page-work-detail" className="text-white title">{project.title}</Link></h5>
                                                <h6 className="text-light tag mb-0">{project.subject}</h6>
                                            </div>
                                            <div className="icons text-center">
                                                <Link to="#" onClick={() => this.setState({ isOpen: true, photoIndex : key })} className="text-primary work-icon bg-white d-inline-block rounded-pill mfp-image"><i><FeatherIcon icon="camera" className="fea icon-sm" /></i></Link>
                                            </div>
                                            </CardBody>
                                        </Card>
                                    </Col>
                            ...
                            <Col className="mt-4 pt-2">
                                <Link to="page-work-modern" className="btn btn-outline-primary">See More <i className="mdi mdi-chevron-right"></i></Link>
                            </Col>
                        </Row>
