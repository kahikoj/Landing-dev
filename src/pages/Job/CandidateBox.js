                                            ...
                                            <ul className="list-unstyled social-icon team-icon mb-0">
                                                {
                                                    candidate.socialIds.map((socialId, key) =>
                                                        <li key={key} className="list-inline-item mr-1"><Link to={socialId.link} className="rounded"><i><FeatherIcon icon={socialId.icon} className="fea icon-sm fea-social" /></i></Link></li>
                                                    )
                                                }
                                            </ul>
                                        </div>
