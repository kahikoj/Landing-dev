        ...
        return (
            ...
            <Container className="mt-100 mt-60">
                <Row className="align-items-center">
                    <Col lg={5} md={5} xs={12}>
                        <img src={download} className="img-fluid mx-auto d-block" alt="Landrick"/>
                    </Col>

                    <Col lg={7} md={7} xs={12} className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div className="section-title">
                            <div className="alert alert-light alert-pills" role="alert">
                                <span className="badge badge-primary badge-pill mr-1">Apps</span>
                                <span className="content">Download now <i><FeatherIcon icon="chevron-right" className="fea icon-sm" /></i></span>
                            </div>
                            ...
                            <div className="my-4">
                                <Link to="#" className="btn btn-lg btn-dark mt-2 mr-2"><i className="mdi mdi-apple"></i> App Store</Link>
                                <Link to="#" className="btn btn-lg btn-dark mt-2 ml-1"><i className="mdi mdi-google-play"></i> Play Store</Link>
                            </div>

                            <div className="d-inline-block">
                                <div className="pt-4 d-flex align-items-center border-top">
                                    <i><FeatherIcon icon="smartphone" className="fea icon-md mr-2 text-primary" /></i>
