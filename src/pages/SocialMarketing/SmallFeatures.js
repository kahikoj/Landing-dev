        ...
        return (
            ...
            <Container className="mt-100 mt-60">
                <Row className="align-items-center">
                    ...
                    <Col lg={7} md={{size:6, order:1}} xs={{size:12, order:2}} className="mt-4 pt-2 mt-sm-0 pt-sm-0">
                        <div className="section-title mr-lg-4">
                            <p className="text-primary h2 mb-3"><i><Unicons.UilLayerGroup size="33" /></i></p>
                            <SectionTitleLeft
                            ...
                            <div className="watch-video mt-4 pt-2">
                                <Link to="#" onClick={this.openModal} className="video-play-icon watch text-dark"><i className="mdi mdi-play play-icon-circle text-center d-inline-block mr-2 rounded-circle title-dark text-white position-relative play play-iconbar"></i> WATCH VIDEO</Link>
                            </div>
                        </div>
                    </Col>
                </Row>
