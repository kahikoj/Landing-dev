            ...
            <Container className="mt-100 mt-60">
                <Row className="justify-content-center">
                    <Col lg={2} md={2} xs={6} className="text-center">
                        <img src={facebook} className="avatar avatar-ex-sm" alt="Landrick"/>
                    </Col>
                    
                    <Col lg={2} md={2} xs={6} className="text-center">
                        <img src={instagram} className="avatar avatar-ex-sm" alt="Landrick"/>
                    </Col>
                    
                    <Col lg={2} md={2} xs={6} className="text-center pt-5 pt-sm-0">
                        <img src={tinder} className="avatar avatar-ex-sm" alt="Landrick"/>
                    </Col>
                    
                    <Col lg={2} md={2} xs={6} className="text-center pt-5 pt-sm-0">
                        <img src={whatsapp} className="avatar avatar-ex-sm" alt="Landrick"/>
                    </Col>
                    
                    <Col lg={2} md={2} xs={6} className="text-center pt-5 pt-sm-0">
                        <img src={google} className="avatar avatar-ex-sm" alt="Landrick"/>
                    </Col>

                    <Col lg={2} md={2} xs={6} className="text-center pt-5 pt-sm-0">
                        <img src={dribble} className="avatar avatar-ex-sm" alt="Landrick"/>
                    </Col>
                </Row>
            </Container>
           </React.Fragment>
