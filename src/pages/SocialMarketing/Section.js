                            ...
                            <Col lg={9} className="text-center mt-0 mt-md-5 pt-0 pt-md-5">
                                <div className="title-heading margin-top-100">
                                    ...
                                    <ul className="mt-4 list-unstyled mb-0 align-items-center">
                                        <li className="list-inline-item mr-1"><Link to="page-contact-one" className="btn btn-primary mr-2"><i className="mdi mdi-email"></i> Request a Demo</Link></li>
                                        <li className="list-inline-item text-muted mr-2 h6">Or</li>
                                        <li className="list-inline-item"><Link to="#" className="text-primary font-weight-bold ml-1"> Try it for Free <i><FeatherIcon icon="chevron-right" className="fea icon-sm" /></i></Link></li>
                                    </ul>
                                </div>
