            ...
            <Container className="mt-100 mt-60">
                <Row className="align-items-center">
                    <Col lg={6} xs={12} className="col--6">
                        <Row className="mr-lg-4" id="counter">
                            <Col md={6} xs={12}>
                                <Row>
                    ...
                    <Col lg={6} xs={12} className="col--6 mt-4 pt-2 mt-lg-0 pt-lg-0">
                        <div className="section-title ml-lg-4">
                            <p className="text-primary h2 mb-3"><i><Unicons.UilApps size="35" /></i></p>
                        ...
                        <div className="section-title mr-lg-4">
                            ...
                            <div className="d-inline-block">
                                <div className="pt-3 d-flex align-items-center border-top">
                                    <i><FeatherIcon icon="cpu" className="fea icon-md mr-2 text-primary" /></i>
