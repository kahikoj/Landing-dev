    ...
    constructor(props) {
        ...
        this.state = {
            keyFeatures : [
                ...
                { icon : "uil uil-chart-pie-alt", title : "Corporate Insurance", link : "#" },
                { icon : "uil uil-heartbeat", title : "Cancer Insurance", link : "#" },
                { icon : "uil uil-chart-line", title : "Tax Saving Investment", link : "#" },
    ...
    render() {
        return (
            ...
            <Container className="mt-100 mt-60">
                ...
                <SectionTitle title="Other Insurance Plans" desc=" that can provide everything you need to generate awareness, drive traffic, connect."/>
