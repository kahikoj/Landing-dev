...
import { Container, Row, Col, Card, CardBody, Form, Input, FormGroup, Button, Label, Alert } from 'reactstrap';
                        ...
                        <Card className="rounded border-0 shadow-lg ml-lg-5">
                            <CardBody>
                                <div className="text-center">
                                    <img src={client1} className="avatar avatar-md-md rounded-circle shadow" alt="Landrick" />
                                    <div className="section-title">
                                        <h6 className="my-3">Calvin Carlo</h6>
                                        <p className="text-muted para-desc mx-auto mb-0">Start working with <span className="text-primary font-weight-bold">Landrick</span> that can provide everything you need.</p>
                                    </div>
                                </div>

                                <div className="content mt-4 pt-2">
                                <Alert color="primary" isOpen={this.state.isOpen} toggle={() => this.setState({isOpen : !this.state.isOpen})} >
                                    ...
                                    <Form onSubmit={this.handleSubmit} >
                                        <Row>
                                            ...
                                            <Col lg={12} className="mt-2">
                                                <Button type="submit" className="btn btn-soft-primary">Request call <i><FeatherIcon icon="arrow-right" className="fea icon-sm" /></i></Button>
                                            </Col>
                                        </Row>
                                    </Form>                                    
                                </div>
