...
import { Container, Row, Col, CardBody, Card, Media } from 'reactstrap';
    ...
    render() {
        return (
            ...
            <Container fluid className="mt-100 mt-60">
                <div className="rounded py-5" style={{ background: `url(${ctaImg}) center center` }}>
                    <Container className="py-md-5 py-3">
                        <Row>
                            <Col lg={{size:6, offset:6}} md={{size:7, offset:5}} xs={12}>
                                <Card className="border-0">
                                    <CardBody className="p-md-5 p-4 bg-white rounded">
                                        ...
                                        <Row>
                                            <Col md={6} xs={12} className="mt-4">
                                                <Media className="align-items-center">
                                                    ...
                                                    <Media body>
                                                        <h6 className="title text-dark mb-0">Protection</h6>
                                                    </Media>
                                                </Media>
                                            </Col>
                                            ...
                                            <Col md={6} xs={12} className="mt-4">
                                                <Media className="align-items-center">
                                                    ...
                                                    <Media body>
                                                        <h6 className="title text-dark mb-0">Customers</h6>
                                                    </Media>
                                                </Media>
                                            </Col>
                                            ...
                                            <Col md={6} xs={12} className="mt-4">
                                                <Media className="align-items-center">
                                                    ...
                                                    <Media body>
                                                        <h6 className="title text-dark mb-0">Save on rates</h6>
                                                    </Media>
                                                </Media>
                                            </Col>
                                        ...
                                        <div className="mt-4">
                                            <Link to="#" className="btn btn-primary">Protect your life <i><FeatherIcon icon="arrow-right" className="fea icon-sm" /></i></Link>
                                        </div>
                                    </CardBody>
                                </Card>
                            </Col>
