...
import { Container, Row, Col, Card, CardBody, Modal, ModalHeader, ModalBody, Label, Button, Input, Form, FormGroup, Badge } from 'reactstrap';
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            works : [
                ...
                { imageUrl : img6, title : "Mockup box with paints", subtitle : "Photography" },
            ],
            isOpen : false,
        }
                    ...
                    <Container className="mt-100 pt-50">
                                    ...
                                    <Col lg="6" md="6" key={key} className="mt-4 pt-2">
                                        <Card className="border-0 work-container work-classic">
                                            <CardBody className="p-0">
                                                <Link to="page-work-detail"><img src={work.imageUrl} className="img-fluid rounded work-image"  alt="work" /></Link>
                        ...
                        <Row className="justify-content-center">
                            <Col xs="12" className="text-center mt-4 pt-2">
                                <Link to="page-work-modern" className="btn btn-primary">See More <i className="mdi mdi-arrow-right"></i></Link>
                            </Col>
                        </Row>
                    </Container>
                        ...
                        <Row className="justify-content-center">
                            <Col xs="12" className="text-center">
                                <div className="section-title">
                                    ...
                                    <div className="mt-3">
                                    <a href="https://1.envato.market/landrickreactjs" target="_blank" rel="noopener noreferrer" className="btn btn-primary mt-2 mr-2">Buy Now{" "}<Badge color="danger" pill className="ml-2">v2.2</Badge></a>
                                        <Link to="#" className="btn btn-outline-primary mt-2 ml-1" onClick={this.openModal} ><i className="mdi mdi-account-check-outline"></i>{" "}Free Trial</Link>
                                    </div>
                                </div>
                            </Col>
                        </Row>
