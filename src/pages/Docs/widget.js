        ...
        return (
            ...
            <Container>
                ...
                <Row>
                    ...
                    <Col lg={4} md={6} xs={12} className=" mt-4 pt-2">
                        <div className="features">
                            <div className="image position-relative d-inline-block">
                                <img src={user} className="avatar avatar-small" alt="Landrick" />
                            </div>
                    ...
                    <Col lg={4} md={6} xs={12} className=" mt-4 pt-2">
                        <Media className="features pt-4 pb-4">
                            <div className="icon text-center rounded-circle text-primary mr-3 mt-2">
                                <i><FeatherIcon icon="monitor" className="fea icon-ex-md" /></i>
                            </div>
                            <Media body>
                        ...
                        <Card className="work-process border-0 rounded shadow">
                            <CardBody>
                                ...
                                <ul className="list-unstyled d-flex justify-content-between mb-0 mt-2">
                                    ...
                                    <li className="step-icon"><i className="mdi mdi-check-all mdi-36px"></i></li>
                                </ul>
                            </CardBody>
                        </Card>
                    </Col>
                    ...
                    <Col lg={4} md={6} xs={12} className=" mt-4 pt-2">
                        <Card className="course-feature text-center overflow-hidden rounded shadow border-0" style={{margin: 0}}>
                            <CardBody className="py-5">
                                <div className="icon">
                                    <img src={insurance} className="avatar avatar-small" alt="Landrick" />
                                </div>
                                ...
                                <img src={insurance} className="full-img" height="300" alt="Landrick" />
                            </CardBody>
                        </Card>
                    </Col>
                    ...
                    <Col lg={4} md={6} xs={12} className=" mt-4 pt-2">
                        <Card className="bg-light rounded shadow border-0">
                            <CardBody className="py-5">
                                <img src={rupee} className="avatar avatar-md-sm" alt="Landrick" />
                                <div className="mt-4">
                                    <h5 className="card-title"><Link to="#" className="text-primary"> Low Fees</Link></h5>
                    ...
                    <Col lg={4} md={6} className="mt-4 pt-2">
                        <Card className="contact-detail text-center border-0">
                            <CardBody className=" p-0">
                                <div className="icon">
                                    <img src={bitcoin} className="avatar avatar-small" alt="Landrick" />
                                </div>
                    ...
                    <Col lg={4} md={6} xs={12} className=" mt-4 pt-2">
                        <Card className="features px-md-3 border-0 text-center">
                            ...
                            <CardBody className="p-0 content mt-3">
                                ...
                                <Link to="#" className="text-primary">Read More <i data-feather="chevron-right" className="fea icon-sm"></i></Link>
                            </CardBody>
                        </Card>
                    </Col>
                    ...
                    <Col lg={4} md={6} xs={12} className=" mt-4 pt-2">
                        <Media className="align-items-center features">
                            <div className="icons m-0 rounded h2 text-primary text-center px-2">
                                <i><Unicons.UilAirplay size="39" /></i>
                            </div>
                ...
                <Row>
                    ...
                    <Col lg={4} md={6} xs={12} className=" mt-4 pt-2">
                        <Media className="customer-testi">
                            <img src={client04} className="avatar avatar-small mr-3 rounded shadow" alt="Landrick" />
                            <Media body className="content p-3 shadow rounded bg-white position-relative">
                    ...
                    <Col lg={4} md={6} xs={12} className=" mt-4 pt-2">
                        <Card className="customer-testi text-center border rounded mx-2">
                            <CardBody>
                                <img src={lenovo} className="img-fluid avatar avatar-ex-sm mx-auto" alt="Landrick" />
                    ...
                    <Col lg={4} md={6} xs={12} className=" mt-4 pt-2">
                        <Card className=" customer-testi m-2 text-center rounded shadow border-0">
                            <CardBody>
                                <p className="text-muted h6 font-italic">" It seems that only fragments of the oem Ipsum', which is said to have originated in the 16th century. "</p>
                                <img src={client05} className="img-fluid avatar avatar-small mt-3 rounded-circle mx-auto shadow" alt="Landrick" />
                    ...
                    <Col lg={4} md={6} xs={12} className=" mt-4 pt-2">
                        <Card className=" customer-testi border-0 text-center">
                            <CardBody>
                                <img src={client04} className="img-fluid avatar avatar-small rounded-circle mx-auto shadow" alt="Landrick" />
                                <p className="text-muted mt-4">" Thus, Lorem Ipsum has only limited suitability as a visual filler for German texts. "</p>
                    ...
                    <Col lg={8} xs={12} className="mt-4">
                        <Card className=" rounded bg-light overflow-hidden border-0 m-2">
                            <Row className="align-items-center no-gutters">
                                <Col md={5}>
                                    <img src={client02} className="img-fluid" alt="Landrick" />
                                </Col>

                                <Col md={7}>
                                    <CardBody className="customer-testi">
                                        <h6 className="text-primary font-weight-bold">Barbara McIntosh <small className="text-muted d-block">User</small></h6>
                                        <ul className="list-unstyled mb-0">
                                            <li className="list-inline-item"><i className="mdi mdi-star text-warning"></i></li>
                                            <li className="list-inline-item"><i className="mdi mdi-star text-warning"></i></li>
                                            <li className="list-inline-item"><i className="mdi mdi-star text-warning"></i></li>
                                        ...
                                        <p className="text-muted h6 mb-0 font-italic">" This seems that only fragments of the original text remain in the Ipsum texts used today. The well known have originated in the 16th century. "</p>
                                    </CardBody>
                                </Col>
                            </Row>
                        </Card>
                ...
                <Row>
                    ...
                    <Col lg={4} md={6} xs={12} className=" mt-4 pt-2">
                        <Card className=" blog rounded border-0 shadow">
                            <div className="position-relative">
                                <img src={blog01} className="card-img-top rounded-top" alt="..."/>
                            ...
                            <CardBody className="content">
                                ...
                                <div className="post-meta d-flex justify-content-between mt-3">
                                    <ul className="list-unstyled mb-0">
                                        <li className="list-inline-item mr-2 mb-0"><Link to="#" className="text-muted like"><i className="mdi mdi-heart-outline mr-1"></i>33</Link></li>
                        ...
                        <Card className=" courses-desc overflow-hidden rounded shadow border-0">
                            ...
                            <CardBody>
                                ...
                                <div className="fees d-flex justify-content-between">
                                    ...
                                    <h4><span className="h6">$</span>75</h4>
                                </div>
                            </CardBody>
                        </Card>
                    </Col>
                        ...
                        <Card className=" blog rounded border-0 shadow overflow-hidden">
                            <div className="position-relative">
                                ...
                                <div className="teacher d-flex align-items-center">
                                    <img src={client01} className="avatar avatar-md-sm rounded-circle shadow" alt="Landrick" />
                                    <div className="ml-2">
                                        <h6 className="mb-0"><Link to="#" className="text-light user">Dung Lewis</Link></h6>
                            ...
                            <CardBody className="content">
                                <small><Link to="#" className="text-primary h6">Design</Link></small>
                                <h5 className="mt-2"><Link to="#" className="title text-dark">Program for Missionaries</Link></h5>
                    ...
                    <Col lg={4} md={6} xs={12} className=" mt-4 pt-2">
                        <Card className=" shop-list border-0 position-relative overflow-hidden">
                            <div className="shop-image position-relative overflow-hidden rounded shadow">
                                <Link to="#"><img src={s14} className="img-fluid" alt="Landrick" /></Link>
                                <Link to="#" className="overlay-work">
                                    <img src={s14Overlay} className="img-fluid" alt="Landrick" />
                                </Link>
                                <ul className="list-unstyled shop-icons">
                                    <li><Link to="#" className="btn btn-icon btn-pills btn-soft-danger"><i><FeatherIcon icon="heart" className="icons" /></i></Link></li>
                                    <li className="mt-2"><Link to="#" className="btn btn-icon btn-pills btn-soft-primary"><i><FeatherIcon icon="eye" className="icons" /></i></Link></li>
                                    <li className="mt-2"><Link to="#" className="btn btn-icon btn-pills btn-soft-warning"><i><FeatherIcon icon="shopping-cart" className="icons" /></i></Link></li>
                                </ul>
                            </div>
                            <CardBody className="content pt-4 p-2">
                                <Link to="#" className="text-dark product-name h6">Women Block Heels</Link>
                                <div className="d-flex justify-content-between mt-1">
                                    <h6 className="text-muted small font-italic mb-0 mt-1">$21.00 <del className="text-danger ml-2">$25.00</del> </h6>
                ...
                <Row>
                    ...
                    <Col lg={4} md={6} xs={12} className=" mt-4 pt-2">
                        <Card className=" border-0 work-container work-classic">
                            <CardBody className=" p-0">
                                <Link to="#"><img src={work2} className="img-fluid rounded work-image" alt="Landrick" /></Link>
                                <div className="content pt-3">
                                    <h5 className="mb-0"><Link to="#" className="text-dark title">Iphone mockup</Link></h5>
                    ...
                    <Col lg={4} md={6} xs={12} className=" mt-4 pt-2">
                        <Card className=" border-0 work-container work-modern position-relative d-block overflow-hidden rounded-0">
                            <CardBody className=" p-0">
                                ...
                                <div className="overlay-work bg-dark"></div>
                                <div className="content">
                                    <h5 className="mb-0"><Link to="#" className="text-white title">Yellow bg with Books</Link></h5>
                                    <h6 className="text-light tag mb-0">Books</h6>
                                </div>
                                <div className="icons text-center">
                                    <Link to={work4} className="text-primary work-icon bg-white d-inline-block rounded-pill mfp-image"><i><i><FeatherIcon icon="camera" className="fea icon-sm" /></i></i></Link>
                                </div>
                            </CardBody>
                        </Card>
                    </Col>
                        ...
                        <Card className=" work-container work-modern rounded border-0 overflow-hidden">
                            <CardBody className=" p-0">
                                ...
                                <div className="read_more bg-primary text-center rounded-circle">
                                    <Link to="#" className="text-light d-block"><i><FeatherIcon icon="chevron-right" className="fea icon-sm title-dark" /></i></Link>
                                </div>
                            </CardBody>
                        </Card>
                    </Col>
                    ...
                    <Col lg={4} md={6} className="mt-4 pt-2">
                        <Card className=" work-container work-modern overflow-hidden rounded border-0 shadow-lg">
                            <CardBody className=" p-0">
                                ...
                                <div className="overlay-work bg-dark"></div>
                                <div className="content">
                                    <Link to="#" className="title text-white d-block font-weight-bold">Michanical Engineer</Link>
                    ...
                    <Col lg={4} md={6} xs={12} className=" mt-4 pt-2">
                        <Card className=" job-box rounded shadow border-0 overflow-hidden">
                            <div className="border-bottom">
                                ...
                                <h5 className="mb-0 position"><Link to="page-job-detail" className="text-dark">Python Developer</Link>
                            ...
                            <CardBody className="content position-relative">
                                <div className="firm-logo rounded-circle shadow bg-light text-center">
                                    <img src={circleCi} className="avatar avatar-md-sm" alt="Landrick" />
                                </div>
                                <div className="company-detail text-center mt-3">
                                    ...
                                    <p className="text-muted"><Link to="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39206.002432144705!2d-95.4973981212445!3d29.709510002925988!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640c16de81f3ca5%3A0xf43e0b60ae539ac9!2sGerald+D.+Hines+Waterwall+Park!5e0!3m2!1sen!2sin!4v1566305861440!5m2!1sen!2sin" className="video-play-icon text-muted"><i data-feather="map-pin" className="fea icon-sm"></i> San Francisco</Link></p>
                                </div>
                                <ul className="job-facts list-unstyled">
                                    <li className="list-inline-item text-muted"><i data-feather="check" className="fea icon-sm text-success mr-1"></i> 2 Year Expirence</li>
                                    <li className="list-inline-item text-muted"><i data-feather="check" className="fea icon-sm text-success mr-1"></i> Working Hours- 6hr</li>
                                    <li className="list-inline-item text-muted"><i data-feather="check" className="fea icon-sm text-success mr-1"></i> Information strategy</li>
                                </ul>
                        ...
                        <Card className=" pricing-rates business-rate shadow bg-light rounded text-center border-0">
                            <CardBody className="py-5">
                                ...
                                <ul className="feature list-unstyled pl-0">
                                    <li className="feature-list text-muted"><i data-feather="check" className="fea icon-sm text-success mr-2"></i>Full Access</li>
                                    <li className="feature-list text-muted"><i data-feather="check" className="fea icon-sm text-success mr-2"></i>Enhanced Security</li>
                                    <li className="feature-list text-muted"><i data-feather="check" className="fea icon-sm text-success mr-2"></i>Source Files</li>
                                    <li className="feature-list text-muted"><i data-feather="check" className="fea icon-sm text-success mr-2"></i>1 Domain Free</li>
                                </ul>
                ...
                <Row>
                    ...
                    <Col lg={5} md={6} className="mt-4 pt-2">
                        <Card className=" rounded shadow bg-light border-0">
                            <CardBody className="py-5">
                                <img src={master} height="60" className="text-right" alt="Landrick" />
                                <div className="mt-4">
                        ...
                        <Row id="counter">
                            <div className="col-12">
                                <Card className=" counter-box border-0 bg-primary shadow text-center rounded">
                                    <CardBody className="py-5">
                                        <h2 className="mb-0 text-light title-dark"><span className="counter-value" data-count="97"><CountUp start={3} end={97} duration={8} /></span>%</h2>
                                        <h5 className="counter-head text-light title-dark mb-0">Happy Client</h5>
                                    </CardBody>
                                </Card>
                            </div>
                        </Row>
                ...
                <Row>
                    ...
                    <Col lg={5} className="mt-4 pt-2">
                        <Card className=" event-schedule rounded border">
                            <CardBody>
                                <Media>
                                    <ul className="date text-center text-primary mr-3 mb-0 list-unstyled">
