                    ...
                    <Container>
                        <Row>
                            <Col>
                                ...
                                <code className="text-success rounded p-2 bg-dark font-weight-bold">import './css/materialdesignicons.min.css';</code><br/><br/>
                                <code className="text-success rounded p-2 bg-dark font-weight-bold">import './css/color/default.css';</code>
                        ...
                        <h5 className="h6 mt-4"><i className="mdi mdi-chevron-right"></i> Light Version : </h5>
                        <div className="mt-4 p-4 bg-light rounded shadow">
                            <p className="mb-0 text-muted">In order to have Light mode enabled, add <code className="font-weight-bold">style.scss</code></p>
                        </div>
                        ...
                        <h5 className="h6 mt-4"><i className="mdi mdi-chevron-right"></i> Change Theme Color : </h5>
                        <div className="mt-4 p-4 bg-light rounded shadow">
                            <p className="mb-0 text-muted">In order to change theme color, replace the default color css of <code className="font-weight-bold">default.css</code> to <code className="font-weight-bold">green.scss</code>(or any other which you want from existing color css) in app.js file</p>
                        </div>
                            </Col>
                        </Row>
                    </Container>
