...
class Collection extends Component {
    render() {
        ...
        <Container fluid className="mt-5 pt-2">
            <Row>
                <Col md={4}>
                    <div className="py-5 rounded shadow" style={{ background: `url(${fea1}) top center` }}>
                        <div className="p-4">
                ...
                <Col md={4} className="mt-4 pt-2 mt-sm-0 pt-sm-0">
                    <div className="py-5 rounded shadow" style={{ background: `url(${fea2}) top center` }}>
                        <div className="p-4">
                            <h3>Summer <br/> Collection</h3>
                            <Link to="#" className="btn btn-sm btn-soft-primary mt-2">Shop Now</Link>
                        </div>
                ...
                <Col md={4} className="mt-4 pt-2 mt-sm-0 pt-sm-0">
                    <div className="py-5 rounded shadow" style={{ background: `url(${fea3}) top center` }}>
                        <div className="p-4">
                            <h3>Summer <br/> Collection</h3>
                            <Link to="#" className="btn btn-sm btn-soft-primary mt-2">Shop Now</Link>
                        </div>
