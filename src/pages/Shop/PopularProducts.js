...
class PopularProducts extends Component {
    constructor(props) {
        ...
        this.state = {
            products : [
                { id : 1, image : product9, imgOverlay : prodtctOverlay9, name : "Coffee Cup / Mug", price : "16.00", oldPrice : "21.00" },
                { id : 2, image : product10, imgOverlay : prodtctOverlay10, name : "Sunglasses", price : "21.00", oldPrice : "25.00" },
                { id : 3, image : product11, imgOverlay : prodtctOverlay11, name : "Loafer Shoes", price : "5.00", desc : "30% off" },
                { id : 4, image : product12, imgOverlay : prodtctOverlay12, name : "T-Shirts", price : "18.00" , oldPrice : "22.00" },
            ]
        }
    }
