                        ...
                        <Card className="pricing-rates business-rate shadow bg-light rounded text-center border-0">
                            <CardBody className="py-5">
                                ...
                                <ul className="feature list-unstyled pl-0">
                                    ...
                                    <li className="feature-list text-muted"><i><FeatherIcon icon="check"  className="fea icon-sm text-success mr-2" /></i>1 Domain Free</li>
                                </ul>
                        ...
                        <Card className="pricing-rates business-rate shadow bg-light rounded text-center border-0">
                            <CardBody className="py-5">
                                ...
                                <ul className="feature list-unstyled pl-0">
                                    ...
                                    <li className="feature-list text-muted"><i><FeatherIcon icon="check"  className="fea icon-sm text-success mr-2" /></i>Free Installment</li>
                                    <li className="feature-list text-muted"><i><FeatherIcon icon="check"  className="fea icon-sm text-success mr-2" /></i>Enhanced Security</li>
                                </ul>
                                    ...
                                    <ul className="list-unstyled feature-list text-muted">
                                        {
                                            ...
                                            <li key={key}><i><FeatherIcon icon="check-circle" className="fea icon-sm text-success mr-2" /></i>{feature.title}</li>
                                            )
                                        }
                                    </ul>
                                </div>
                                ...
                                <Row>
                                    <Col xs={12} className="mt-4 mt-lg-0 pt-2 pt-lg-0">
                                        <Card className="counter-box border-0 bg-light shadow text-center rounded">
                                            <CardBody className="py-5">
                                                <h2 className="mb-0"><span className="counter-value"><CountUp start={3} end={97} duration={8} /></span>%</h2>
                                    ...
                                    <Col xs={12}  className="mt-4 pt-2">
                                        <Card className=" counter-box border-0 bg-primary shadow text-center rounded">
                                            <CardBody className="py-5">
                                                <h2 className="text-light title-dark mb-0"><span className="counter-value"><CountUp start={1} end={15} duration={8} /></span>+</h2>
                                                <h5 className="counter-head mb-0 title-dark text-light">Awards</h5>
                                            </CardBody>
                                        </Card>
                                    </Col>
                                </Row>
                                ...
                                <Row className="pt-lg-4 mt-lg-4">
                                    <Col xs={12}  className="mt-4 pt-2">
                                        <Card className="counter-box border-0 bg-success shadow text-center rounded">
                                            <CardBody className="py-5">
                                                <h2 className="text-light title-dark mb-0"><span className="counter-value" ><CountUp start={0} end={2} duration={8} /></span>K</h2>
                                                <h5 className="counter-head mb-0 title-dark text-light">Job Placement</h5>
                                            </CardBody>
                                        </Card>
                                    </Col>
                                    ...
                                    <Col xs={12}  className="mt-4 pt-2">
                                        <Card className="counter-box border-0 bg-light shadow text-center rounded">
                                            <CardBody className="py-5">
                                                <h2 className="mb-0"><span className="counter-value" ><CountUp start={3} end={98} duration={8} /></span>%</h2>
