                            ...
                            <div className="mt-4 pt-2 text-center">
                                {
                                    this.state.coins.map((coin, key) =>
                                        <Link to={coin.link} key={key} className="ml-1">
                                            <img src={coin.image} className="img-fluid avatar avatar-small m-2 p-2 rounded-circle shadow" id={coin.id} alt=""/>
                            ...
                            <Card className="mt-4 pt-2 rounded shadow border-0">
                                <CardBody>
                                    ...
                                    <div className="progress-box mt-4">
                                        <Progress color="primary" barClassName="position-relative" striped value={67} />
                                    </div>
