                ...
                <Row className="align-items-center">
                    <Col lg={6} md={6}>
                        <div className="title-heading mt-4">
                            <Alert color="light" className="alert-pills shadow" role="alert">
                                <Badge pill color="danger" className="mr-1">v2.2</Badge>
                            ...
                            <div className="watch-video mt-4 pt-2">
                                ...
                                <Link to="#" onClick={this.openModal} className="video-play-icon watch text-dark mb-2 ml-2"><i className="mdi mdi-play play-icon-circle text-center d-inline-block mr-2 rounded-circle bg-light text-white title-dark position-relative play play-iconbar"></i> Watch now !</Link>
                            </div>
                        </div>
                    </Col>
