                    ...
                    <Col md={6} className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div className="section-title">
                            ...
                            <div className="watch-video mt-4 pt-2">
                                <Link to="#" className="btn btn-primary mb-2 mr-2">Read More <i className="mdi mdi-chevron-right"></i></Link>
                                <Link to="#" onClick={this.openModal} className="video-play-icon watch text-dark ml-1"><i className="mdi mdi-play play-icon-circle text-center d-inline-block mr-2 rounded-circle title-dark text-white position-relative play play-iconbar"></i> WATCH VIDEO</Link>
                            </div>
                        </div>
                    </Col>
                </Row>
