        ...
        <section className="section border-bottom bg-light">
            <Container>
                <Row className="align-items-center">
                    <Col lg={5} md={{size:5, order:2}} xs={{size:12, order:1}}>
                        <img src={userInterface} className="img-fluid mx-auto d-block" alt="Landrick" />
                    </Col>

                    <Col lg={7} md={{size:7, order:1}} xs={{size:12, order:2}} className="mt-4 mt-sm-0 pt-2 pt-sm-0">
