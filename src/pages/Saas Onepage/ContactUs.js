                                ...
                                <CardBody className="p-0">
                                    <div className="contact-detail d-flex align-items-center mt-3" data-aos="fade-up" data-aos-duration="1200">
                                        ...
                                        <div className="content overflow-hidden d-block">
                                            ...
                                            <Link to="#" className="text-primary">contact@example.com</Link>
                                        </div>
                                    </div>
                                </CardBody>
                            </Card>
                                ...
                                <CardBody className="p-0">
                                    <div className="contact-detail d-flex align-items-center mt-3" data-aos="fade-up" data-aos-duration="1200">
                                        ...
                                        <div className="content overflow-hidden d-block">
                                            ...
                                            <Link to="#" className="text-primary">+152 534-468-854</Link>
                                        </div>
                                    </div>
                                </CardBody>
                            </Card>
                            ...
                            <Card className="border-0 bg-transparent">
                                <CardBody className="p-0">
                                    <div className="contact-detail d-flex align-items-center mt-3" data-aos="fade-up" data-aos-duration="1200">
                                        ...
                                        <div className="content overflow-hidden d-block">
                                            <h6 className="font-weight-bold mb-0">Location</h6>
