...
class Team extends Component {
    state = {
        candidates : [
            ...
            { id : 2, image : image4, name : "Micheal Carlo", designation : "Web Designer", salary : "1950", link : "",
                socialIds : [
                    { icon : "facebook", link : "#" },
                    { icon : "instagram", link : "#" },
                    { icon : "twitter", link : "#" },
            ...
            { id : 4, image : image2, name : "Sofia Razaq", designation : "Php Developer", salary : "2190", link : "",
                socialIds : [
                    { icon : "facebook", link : "#" },
                    { icon : "instagram", link : "#" },
                    { icon : "twitter", link : "#" },
