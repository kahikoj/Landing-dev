                                    ...
                                    <Col lg={{size:7, offset:1}} md={{size:6, order:2}} xs={{order:1}}>
                                        <div className="title-heading mt-4">
                                            ...
                                            <div className="watch-video mt-4 pt-2">
                                                ...
                                                <Link  to="#" onClick={this.openModal} className="video-play-icon watch title-dark text-light mb-2 ml-1"><i className="mdi mdi-play play-icon-circle text-center d-inline-block mr-2 rounded-pill text-white title-dark position-relative play play-iconbar"></i> WATCH VIDEO</Link>
