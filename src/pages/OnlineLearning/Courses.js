    ...
    render() {
        ...
        <section className="section">
            <Container>
                ...
                <SectionTitle title="Get a choice of your course" desc=" that can provide everything you need to generate awareness, drive traffic, connect."/>
                ...
                <Row>
                                ...
                                <Card className="explore-feature border-0 rounded text-center bg-white">
                                    <CardBody className="py-5">
                                        <div className="icon rounded-circle shadow-lg d-inline-block">
                                            <i><FeatherIcon icon={course.icon} className="fea" /></i>
                                        </div>
                                        <div className="content mt-3">
                                            <h5><Link to={course.link} className="title text-dark">{course.title}</Link></h5>
                                            <Link to={course.link} className="text-muted small">Learn More</Link>
                                        </div>
                                    </CardBody>
                                </Card>
                            </Col>
                    ...
                    <Col xs={12}>
                        <div className="text-center mt-4 pt-2">
                            <Link to="#" className="btn btn-primary">See More Courses <i><FeatherIcon icon="chevron-right" className="fea icon-sm" /></i></Link>
                        </div>
                    </Col>
                </Row>
            </Container>
