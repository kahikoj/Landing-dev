...
import { Container, Row, Col, Alert, FormGroup, Button, Form } from 'reactstrap';
                            ...
                            <Row className="align-items-center">
                                <Col lg={7} md={6} xs={12}>
                                    <div className="title-heading">
                                        <Alert color="primary" className="alert-pills shadow" role="alert">
                                        ...
                                        <div className="subcribe-form mt-4 pt-2">
                                            <Form className="ml-0">
                                                <FormGroup>
                                                    <input type="text" id="course" name="name" className="rounded" placeholder="Search your course"/>
                                                    <Button color="primary" type="submit">Search <i><FeatherIcon icon="search" className="fea icon-sm" /></i></Button>
                                                </FormGroup>
                                            </Form>
                                        </div>
                                    </div>
                                ...
                                <Col lg={5} md={6} xs={12} className="mt-4 pt-2 mt-sm-0 pt-sm-0">
                                    <div className="position-relative">
                                        <img src={hero} className="rounded img-fluid mx-auto d-block" alt="Landrick" />
