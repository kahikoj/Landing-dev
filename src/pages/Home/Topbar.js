...
class Topbar extends Component {
    constructor(props){
        ...
        this.state = {
            navItems : [
                { id: 1 , idnm : "demos", navheading: "Demos" },
                { id: 2 , idnm : "features", navheading: "Feature" },
                { id: 3 , idnm : "review", navheading: "Reviews" },
                ],
                isOpen : false, 
        };
            ...
            <React.Fragment>
                <header id="topnav" className="defaultscroll sticky">
                    <Container>
                        ...
                        <a href="https://1.envato.market/landrickreactjs" target="_blank" rel="noopener noreferrer" className="btn btn-primary">Download</a>
                        </div>
