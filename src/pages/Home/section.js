                                ...
                                <Row className="align-items-center">
                                    <Col lg={7} md={7}>
                                        <div className="title-heading mt-4">
                                            ...
                                            <div className="mt-4">
                                                <Link to="page-contact-one" className="btn btn-primary mt-2 mr-2"><i className="mdi mdi-email mr-1"></i>Get Started</Link>
                                                <Link to="documentation" className="btn btn-outline-primary mt-2 ml-1"><i className="mdi mdi-book-outline mr-1"></i>Documentation</Link>
                                            </div>
                                        </div>
                                    </Col>
