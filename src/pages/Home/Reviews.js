                ...
                <Row className="justify-content-center">
                    <Col xs={12}>
                        <div className="section-title mb-4 text-center">
                            <h4 className="title text-uppercase font-weight-bold">Happy Clients</h4>
                        </div>
                    </Col>  
                </Row>
                ...
                <Row className="justify-content-center">
                    <Col xs={12}>
                        <div className="section-title text-center">
                            <h4 className="title mb-4 text-uppercase font-weight-bold">Get Started With Landrick<span className="text-primary">.</span></h4>
                            ...
                            <div className="mt-4 pt-2">
                                <Link to="https://1.envato.market/4n73n" target="_blank" className="btn btn-primary">Download Now <span className="badge badge-pill badge-danger ml-2">v2.2</span></Link>
                            </div>
                        </div>
                    </Col>  
                </Row>
