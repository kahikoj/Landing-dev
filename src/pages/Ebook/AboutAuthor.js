    ...
    render() {
        return (
            ...
            <Container fluid className="mt-100 mt-60">
                <div className="bg-light py-5 rounded shadow" style={{ background: `url(${auther}) center center` }}>
                    <Container>
                        <Row className="align-items-center">
                            <Col lg={6} md={6}>
                                <div className="section-title text-center">
                                    <img src={client05} className="img-fluid rounded-circle shadow-lg" alt="Landrick" />
                                </div>
                            </Col>
                            ...
                            <Col lg={6} md={6} className="mt-4 pt-2 mt-sm-0 pt-sm-0">
                                <div className="ml-md-5">
                                    <div>
                                        ...
                                        <p className="text-muted">The comparison of different typefaces. Furthermore, it is advantageous when the dummy text is relatively realistic so that the layout impression of the final publication is not compromised.</p>
                                        ...
                                        <ul className="list-unstyled social-icon mb-0 mt-3">
                                            ...
                                            <li className="list-inline-item"><Link to="#" className="rounded"><i><FeatherIcon icon="linkedin" className="fea icon-sm fea-social" /></i></Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </Col>
