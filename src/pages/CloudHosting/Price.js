...
import { Container, Row, Col, Nav, NavItem, NavLink, TabContent, TabPane, Badge, Card, CardBody } from 'reactstrap';
...
class Price extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            pricings2 : [
                { id : 1, title : "CLOUD HOSTING", price : 29, duration : "mo", buttonText: "Buy Now", btnLink: "",
                    features : [
                        {title : "2 GB Memory"},
                        {title : "10 Free Optimization"},
                        {title : "24/7 support"},
                ...
                { id : 2, title : "DEDICATED HOSTING", price : 239, duration : "mo", buttonText: "Get Started", btnLink: "", isActive : true,
                    features : [
                        {title : "2 GB Memory"},
                        {title : "10 Free Optimization"},
                        {title : "24/7 support"},
                ...
                { id : 4, title : "SHARED HOSTING", price : 479, duration : "mo", buttonText: "Buy Now", btnLink: "",
                    features : [
                        {title : "2 GB Memory"},
                        {title : "10 Free Optimization"},
                        {title : "24/7 support"},
                                ...
                                <div className="text-center">
                                        <Nav pills justified className="rounded-pill justify-content-center d-inline-block border py-1 px-2">
                                            ...
                                            <NavItem className="d-inline-block">
                                                ...
                                                >
                                                    Yearly <Badge pill color="success">15% Off </Badge>
                                                </NavLink>
                                            </NavItem>
                                        </Nav>
                                </div>
                                        ...
                                        <Row>
                                            {
                                                this.state.pricings1.map((pricing, key) =>
                                                    <Col lg={3} key={key} md={6} xs={12} className="mt-4 pt-2">
                                                        <Card className={pricing.isActive ? "pricing-rates starter-plan bg-white shadow rounded text-center border-0" : "pricing-rates bg-light rounded text-center border-0"}>
                                                            <CardBody className="py-5">
                                                                <h2 className={pricing.isActive ? "title text-uppercase mb-4 text-primary" : "title text-uppercase mb-4"}>{pricing.title}</h2>
