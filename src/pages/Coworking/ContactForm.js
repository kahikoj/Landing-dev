                            ...
                            <Col lg="8" md="7">
                                <div className="section-title mr-lg-4">
                                    ...
                                    <div className="watch-video mt-4 pt-2">
                                        ...
                                        <Link to="#" onClick={this.openModal} className="video-play-icon watch title-dark text-light mb-2"><i className="mdi mdi-play play-icon-circle text-center d-inline-block mr-2 rounded-circle text-white title-dark position-relative play play-iconbar"></i> WATCH VIDEO</Link>
                                    </div>
                                </div>
                            </Col>
                                        ...
                                        <Row className="mt-4">
                                            <Col lg="12">
                                                <FormGroup className="mb-3 position-relative">
                                                    ...
                                                    <Input name="name" id="name3" type="text" className="form-control pl-5" placeholder="Name" required />
                                                </FormGroup>
                                            </Col>
                                            ...
                                            <Col lg="12">
                                                <FormGroup className="mb-3 position-relative">
                                                    ...
                                                    <Input type="email" id="email3" className="form-control pl-5" placeholder="Email" name="email" required />
                                                </FormGroup>
                                            </Col>
                                            ...
                                            <Col md="12">
                                                <FormGroup className="position-relative">
                                                    ...
                                                    <Input name="number" id="number" type="number" className="form-control pl-5" placeholder="phone no. :" required />
                                                </FormGroup>
                                            </Col>
