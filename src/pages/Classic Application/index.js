                        ...
                        <Row className="align-items-center">
                            <Col lg="7" md="7">
                                <div className="title-heading mt-4">
                                    <Alert color="none" className="alert-transparent alert-pills shadow" role="alert">
                                    ...
                                    <div className="watch-video mt-4 pt-2">
                                        ...
                                        <Link to="#"  onClick={this.openModal} className="video-play-icon watch title-dark text-dark mb-2 ml-1"><i className="mdi mdi-play play-icon-circle text-center d-inline-block mr-2 rounded-circle text-white title-dark position-relative play play-iconbar"></i> WATCH VIDEO</Link>                                        
                                    </div>
                                </div>
                            </Col>
