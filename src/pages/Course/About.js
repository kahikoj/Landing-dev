                            ...
                            <Col lg="7" md="6" xs="12" className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                                <div className="section-title ml-lg-4">
                                    ...
                                    <ul className="list-unstyled feature-list mb-0 text-muted">
                                        <li><i><FeatherIcon icon="chevron-right" className="fea icon-sm text-success mr-2" /></i>Digital Marketing Solutions for Tomorrow</li>
                                        <li><i><FeatherIcon icon="chevron-right" className="fea icon-sm text-success mr-2" /></i>Our Talented & Experienced Marketing Agency</li>
                                        <li><i><FeatherIcon icon="chevron-right" className="fea icon-sm text-success mr-2" /></i>Create your own skin to match your brand</li>
                                    </ul>
