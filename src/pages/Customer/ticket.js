...
import { Container, Row, Col, Form, Input, FormGroup, Label, Alert, Card, CardBody } from "reactstrap";
            ...
            <SectionTitle title="Submit A Ticket" desc="that can provide everything you need to generate awareness, drive traffic, connect." />
                ...
                <Row className="align-items-center">
                    ...
                    <Col lg="6" md="7" xs="12" className="mt-4 pt-2">
                        <Alert color="primary" isOpen={this.state.ticketVisible} toggle={()=>{ this.setState({ticketVisible : !this.state.ticketVisible}) }}>
                            Ticket details send successfully.
                        </Alert>
                        <Card className="rounded shadow border-0 ml-lg-4">
                            <CardBody className="p-4">
                                <Form onSubmit={this.handleSubmit} data-aos="fade-up" data-aos-duration="1400">
                                    <Row>
                                        <Col md="6">
                                        ...
                                        <Col md="6">
                                            <FormGroup className="position-relative">
                                                ...
                                                <Input name="url" id="url" type="url" className="form-control pl-5" placeholder="Url :" required/>
                                            </FormGroup>
                                        </Col>
                                        <Col md="12">
                                            <FormGroup className="position-relative">
