                            ...
                            <Col xs="12" className="text-center">
                                <div className="section-title">
                                    ...
                                    <div className="watch-video mt-4 pt-2">
                                        <a href="https://1.envato.market/landrickreactjs" target="_blank" rel="noopener noreferrer" className="btn btn-primary mb-2 mr-1">Buy Now <Badge color="danger" pill className="ml-2">v2.2</Badge></a>
