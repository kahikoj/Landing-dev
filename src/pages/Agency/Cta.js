...
class Cta extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <section className="section bg-cta" style={{ background : `url(${bgImg}) center center` }} >
                        ...
                        <Row className="justify-content-center">
                            <Col xs="12" className="text-center">
                                <div className="section-title">
                                    ...
                                    <Link to="#" onClick={this.openModal} className="play-btn border border-light mt-4 video-play-icon">
