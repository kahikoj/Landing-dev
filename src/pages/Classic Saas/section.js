                        ...
                        <Row className="align-items-center pt-5">
                            <Col lg="7" md="6">
                                <div className="title-heading">
                                    ...
                                    <a href="https://1.envato.market/landrickreactjs" target="_blank" rel="noopener noreferrer"  className="btn btn-primary">Buy Now<Badge color="danger" pill className="ml-2">v2.2</Badge></a>
                                    </div>
                                </div>
                            </Col>
