...
import { Container, Row, Col, Alert, Form, Input, Label, Breadcrumb, BreadcrumbItem, Card, CardBody } from 'reactstrap';
                                            ...
                                            <Row>
                                                ...
                                                <Col md={12}>
                                                    <div className="form-group position-relative">
                                                        ...
                                                        <Input name="subject" id="subject" type="text" className="form-control pl-5" placeholder="Subject" required/>
                                                    </div>
                                                </Col>
                                                <Col md={12}>
                                                    <div className="form-group position-relative">
