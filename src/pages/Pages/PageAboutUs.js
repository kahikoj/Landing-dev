    ...
    constructor(props) {
        ...
        this.state = {
            ...
            keyfeatures : [
                ...
                { icon : "bold", title : "Based On Bootstrap 4" },
            ...
            candidates : [
                { id : 1, image : team1, name : "Ronny Jofra", designation : "C.E.O", link : "",
                    socialIds : [
                        { icon : "facebook", link : "#" },
                        { icon : "instagram", link : "#" },
                        { icon : "twitter", link : "#" },
                ...
                { id : 2, image : team4, name : "Micheal Carlo", designation : "Director", link : "",
                    socialIds : [
                        { icon : "facebook", link : "#" },
                        { icon : "instagram", link : "#" },
                        { icon : "twitter", link : "#" },
                ...
                { id : 3, image : team2, name : "Aliana Rosy", designation : "Manager", link : "",
                    socialIds : [
                        { icon : "facebook", link : "#" },
                        { icon : "instagram", link : "#" },
                        { icon : "twitter", link : "#" },
                ...
                { id : 4, image : team3, name : "Sofia Razaq", designation : "Developer", link : "",
                    socialIds : [
                        { icon : "facebook", link : "#" },
                        { icon : "instagram", link : "#" },
                        { icon : "twitter", link : "#" },
