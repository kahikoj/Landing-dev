...
import { Container, Row, Col, Form, Button, FormGroup, Card, CardBody, Collapse, CardHeader, Media } from 'reactstrap';
...
class HelpCenterOverview extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            features : [
                { icon : "uil uil-question-circle", link : "/helpcenter-faqs", title : "FAQs", desc : "Due to its widespread use as filler text for layouts, non-readability is of great importance." },
                { icon : "uil uil-file-bookmark-alt", link : "/helpcenter-guides", title : "Guides / Support", desc : "Due to its widespread use as filler text for layouts, non-readability is of great importance." },
                { icon : "uil uil-cog", link : "/helpcenter-support-request", title : "Support Request", desc : "Due to its widespread use as filler text for layouts, non-readability is of great importance." },
            ],
            col1: true,
			col2: false,
			col3: false,
                ...
                <div className="subcribe-form mt-4 pt-2">
                    <Form>
                        <FormGroup className="mb-0">
                            <input type="text" id="help" name="name" className="border bg-white rounded-pill shadow" required placeholder="Search your questions or topic..."/>
                                ...
                                <Card className="explore-feature border-0 rounded text-center bg-white">
                                    <CardBody>
                                        ...
                                        <div className="content mt-3">
                                            <Link to={feature.link} className="title h5 text-dark">{feature.title}</Link>
                            ...
                            <div className="accordion" id="accordionExample">
                                <Card className="border-0 rounded mb-2">
                                    <Link to="#" onClick={this.t_col1} className={this.state.col1 ? "faq position-relative text-primary" : "faq position-relative text-dark"}>
                                        <CardHeader className="border-0 shadow bg-light p-3" id="headingOne">
                                            <h5 className="title mb-0"> How does it work ? 
                                ...
                                <Card className="border-0 rounded mb-2">
                                    <Link to="#" onClick={this.t_col2} className={this.state.col2 ? "faq position-relative text-primary" : "faq position-relative text-dark"} >
                                        <CardHeader className="border-0 shadow bg-light p-3" id="headingTwo">
                                            <h5 className="title mb-0"> Do I need a designer to use Landrick ? 
                                ...
                                <Card className="border-0 rounded mb-2">
                                    <Link to="#" onClick={this.t_col3} className={this.state.col3 ? "faq position-relative text-primary" : "faq position-relative text-dark"}>
                                        <CardHeader className="border-0 shadow bg-light p-3" id="headingfive">
                                            <h5 className="title mb-0"> What do I need to do to start selling ? 
                                ...
                                <Card className="border-0 rounded mb-0">
                                    <Link to="#" onClick={this.t_col4} className={this.state.col4 ? "faq position-relative text-primary" : "faq position-relative text-dark"}>
                                        <CardHeader className="border-0 shadow bg-light p-3" id="headingfive">
                                            <h5 className="title mb-0"> What happens when I receive an order ? 
