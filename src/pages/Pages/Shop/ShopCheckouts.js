...
import { Container, Row, Col, Table, Input,FormGroup, Form, Label, CustomInput } from 'reactstrap';
                    ...
                    <Col lg={7} md={6}>
                        ...
                        <div className="form-check form-check-inline my-4">
                            <FormGroup className="mb-0">
                                    <CustomInput type="checkbox" label="Create an account ?" id="newaccount"/>
                            </FormGroup>
                        </div>
                        ...
                        <div className="rounded shadow-lg p-4">
                            <div className="form-check form-check-inline">
                                <FormGroup>
                                        <CustomInput type="checkbox" label="Ship to a different address ?"  id="addnewaddress"/>
                                </FormGroup>
                            </div>
                    ...
                    <Col lg={5} md={6} className=" mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div className="rounded shadow-lg p-4">
                            <div className="d-flex mb-4 justify-content-between">
                                <h5>4 Items</h5>
                                <Link to="shop-cart" className="text-muted h6">Show Details</Link>
                            </div>
                            <div className="table-responsive">
                                ...
                                <ul className="list-unstyled mt-4 mb-0">
                                    <li>
                                            <FormGroup className="mb-0">
                                                <CustomInput inline={true} type="radio" label="Bank Transfer" id="banktransfer" defaultChecked name="customRadio" />
                                            </FormGroup>
                                    </li>

                                    <li className="mt-3">
                                            <FormGroup className="mb-0">
                                                <CustomInput type="radio" id="chaquepayment" inline={true} label="Cheque Payment" name="customRadio" />
                                            </FormGroup>
                                    </li>

                                    <li className="mt-3">
                                            <FormGroup className="mb-0">
                                                <CustomInput type="radio" id="cashpayment" name="customRadio" inline={true} label="Cash on Delivery"/>
                                            </FormGroup>
                                    </li>

                                    <li className="mt-3">
                                            <FormGroup className="mb-0">
                                                <CustomInput type="radio" id="paypal" name="customRadio" label="Paypal" inline={true}/>
                                                <Label><Link to="https://www.paypal.com/uk/webapps/mpp/paypal-popup" target="_blank" className="text-primary">What is paypal?</Link></Label>
                                            </FormGroup>
                                    </li>
                                </ul>

                                <div className="mt-4 pt-2">
                                    <Link to="shop-checkouts" className="btn btn-block btn-primary">Place Order</Link>
                                </div>
                            </div>
                        </div>
                    </Col>
