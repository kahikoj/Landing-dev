                            ...
                            <CardBody className="p-0">
                                ...
                                <div className="widget mt-4 pt-2">
                                    ...
                                    <ul className="list-unstyled mt-4 mb-0">
                                        <li className="list-inline-item"><Link to="#" className="px-3 py-1 rounded-pill bg-primary"></Link></li>
                                        <li className="list-inline-item"><Link to="#" className="px-3 py-1 rounded-pill bg-danger ml-1"></Link></li>
                                        <li className="list-inline-item"><Link to="#" className="px-3 py-1 rounded-pill bg-success ml-1"></Link></li>
                                        <li className="list-inline-item"><Link to="#" className="px-3 py-1 rounded-pill bg-info ml-1"></Link></li>
                                        <li className="list-inline-item"><Link to="#" className="px-3 py-1 rounded-pill bg-secondary ml-1"></Link></li>
                                        <li className="list-inline-item"><Link to="#" className="px-3 py-1 rounded-pill bg-warning ml-1"></Link></li>
                                    </ul>
                                </div>
