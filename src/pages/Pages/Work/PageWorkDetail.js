...
import { Container, Row, Col, Alert, Form, FormGroup, Input, Label, Button, Card, CardBody } from 'reactstrap';
            ...
            <React.Fragment>
                ...
                <PageBreadcrumb pathItems = {this.state.pathItems}>
                    ...
                    <ul className="list-unstyled mt-4">
                        ...
                        <li className="list-inline-item h6 date text-muted ml-1"> <span className="text-dark">Date :</span> 23th Sep, 2019</li>
                    </ul>
                </PageBreadcrumb>
                        ...
                        <Row className="justify-content-center">
                            ...
                            <Col md={10} className="mt-4 pt-2">
                                ...
                                <div className="bg-light rounded p-4 mt-4 pt-2">
                                    <p className="text-muted font-italic mb-0">" There is now an abundance of readable dummy texts. These are usually used when a text is required purely to fill a space. These alternatives to the classic Lorem Ipsum texts are often amusing and tell short, funny or nonsensical stories. "</p>

                                    <ul className="list-unstyled feature-list text-muted mt-4">
                                        <li><i><FeatherIcon icon="check-circle" className="fea icon-sm text-success mr-2" /></i>Digital Marketing Solutions for Tomorrow</li>
                                        <li><i><FeatherIcon icon="check-circle" className="fea icon-sm text-success mr-2" /></i>Our Talented & Experienced Marketing Agency</li>
                                        <li><i><FeatherIcon icon="check-circle" className="fea icon-sm text-success mr-2" /></i>Create your own skin to match your brand</li>
                                        <li><i><FeatherIcon icon="check-circle" className="fea icon-sm text-success mr-2" /></i>Digital Marketing Solutions for Tomorrow</li>
                                        <li><i><FeatherIcon icon="check-circle" className="fea icon-sm text-success mr-2" /></i>Our Talented & Experienced Marketing Agency</li>
                                    </ul>
                                </div>
