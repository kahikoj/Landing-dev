...
import { Container, Row, Col, Nav, NavItem, NavLink, TabContent, TabPane, Badge, Card, CardBody, Media } from 'reactstrap';
                                    ...
                                    <Col md={4} xs={12} key={key} className="mt-4 pt-2">
                                        <Card className="pricing-rates business-rate shadow bg-light rounded text-center border-0">
                                            <CardBody className="py-5">
                                                ...
                                                <Link to={pricing.btnLink} className="btn btn-primary mt-4">{pricing.buttonText}</Link>
                                            </CardBody>
                                        </Card>
                                    </Col>
                                )
                                ...
                                <div className="text-center">
                                    <Nav pills className="rounded-pill justify-content-center d-inline-block border py-1 px-2">
                                        ...
                                        <NavItem className="d-inline-block">
                                            ...
                                            >
                                                Yearly <Badge color="success" pill>15% Off </Badge>
                                            </NavLink>
                                        </NavItem>
                                    </Nav>
                                </div>
                            ...
                            <div xs="12" className="text-center">
                                <div className="section-title">
                                    ...
                                    <div className="mt-4 pt-2">
                                        <Link to="page-contact-two" className="btn btn-primary">Contact us <i className="mdi mdi-arrow-right"></i></Link>
                                    </div>
                                </div>
                            </div>
                        </Row>
