...
import { Container, Row, Col, Modal, ModalHeader, ModalBody, Progress, Form, FormGroup, Input, Label, Card, CardBody, Media } from "reactstrap";
...
class PageJobCandidate extends Component {
    ...
    render() {
        return (
            <React.Fragment>
        <section className="bg-half-260 d-table w-100" style={{background: `url(${imgbg})`}}>
                    ...
                    <Col lg="4" md="5" xs="12">
                        <Card className="job-profile shadow border-0">
                                <div className="text-center py-5 border-bottom rounded-top">
                                    <img src={profile} className="avatar avatar-medium mx-auto rounded-circle shadow d-block" alt="profile"/>
                                ...
                                <CardBody>
                                    ...
                                    <ul className="list-unstyled feature-list">
                                        <li className="h6"><i><FeatherIcon icon="mail" className="fea icon-sm text-warning mr-2" /></i><span className="text-muted">Email :</span> thomas@mail.com</li>
                                        ...
                                        <li>
                                            <ul className="list-unstyled social-icon mb-0 mt-4">
                                                <li className="list-inline-item ml-1"><Link to="#" className="rounded"><i><FeatherIcon icon="facebook" className="fea icon-sm fea-social" /></i></Link></li>
                                                <li className="list-inline-item ml-1"><Link to="#" className="rounded"><i><FeatherIcon icon="instagram" className="fea icon-sm fea-social" /></i></Link></li>
                                                <li className="list-inline-item ml-1"><Link to="#" className="rounded"><i><FeatherIcon icon="twitter" className="fea icon-sm fea-social" /></i></Link></li>
                                                <li className="list-inline-item ml-1"><Link to="#" className="rounded"><i><FeatherIcon icon="linkedin" className="fea icon-sm fea-social" /></i></Link></li>
                    ...
                    <Col lg="8" md="7" xs="12" className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div className="ml-lg-4">
                                    ...
                                    <Col key={key} lg="12" className="mt-4 pt-2">
                                        <Media>
                                            <div className="company-logo text-muted h6 mr-3 text-center">
                                                <img src={exp.image} className="avatar avatar-md-sm mx-auto d-block mb-2" alt="experience"/>{exp.duration}
                                            </div>
                                            <Media body>
                                        ...
                                        <Col key={key} md={6} xs={12} className="mt-4 pt-2">
                                            <Card className="border-0 work-container work-classic">
                                                <CardBody className="p-0">
                                                    <Link to="page-work-detail"><img src={project.image} className="img-fluid rounded work-image" alt="Landrick"/></Link>
                                                    <div className="content pt-3">
                                                        <h5 className="mb-0"><Link to="page-work-detail" className="text-dark title">{project.title}</Link></h5>
                                                        <h6 className="text-muted tag mb-0">{project.subtitle}</h6>
                                                    </div>
                                                </CardBody>
                                            </Card>
                                        </Col>
                            ...
                            <div className="mt-4 pt-2">
                                ...
                                <Link to="#" className="btn btn-outline-primary ml-1"><i className="mdi mdi-printer"></i> Print CV</Link>
                            </div>
                        </div>
                    </Col>
                </Row>
