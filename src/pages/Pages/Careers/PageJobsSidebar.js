...
import { Container,Row, Col,Form, Input, FormGroup, Label, Pagination, PaginationItem, PaginationLink, Card, CardBody } from 'reactstrap';
                                        ...
                                        <div className="mt-4">
                                            <div className="custom-control custom-radio">
                                                <FormGroup className="mb-2">
                                                    ...
                                                    <Label className="custom-control-label" htmlFor="lasthour">Last Hour</Label>
                                                </FormGroup>
                                            </div>
                                            ...
                                            <div className="custom-control custom-radio">
                                                <FormGroup className="mb-2">
                                                    ...
                                                    <Label className="custom-control-label" htmlFor="oneday">Last 24 hours</Label>
                                                </FormGroup>
                                            </div>
                                            ...
                                            <div className="custom-control custom-radio">
                                                <FormGroup className="mb-2">
                                                    ...
                                                    <Label className="custom-control-label" htmlFor="sevenday">Last 7 days</Label>
                                                </FormGroup>
                                            </div>
                                            ...
                                            <div className="custom-control custom-radio">
                                                <FormGroup className="mb-2">
                                                    ...
                                                    <Label className="custom-control-label" htmlFor="fourteenday">Last 14 days</Label>
                                                </FormGroup>
                                            </div>
                                            ...
                                            <div className="custom-control custom-radio">
                                                <FormGroup className="mb-0">
                                                    ...
                                                    <Label className="custom-control-label" htmlFor="onemonth">Last 30 days</Label>
                                                </FormGroup>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="mt-4">
                                            <FormGroup className="mb-2">
                                                <div className="custom-control custom-checkbox">
                                                    ...
                                                    <Label className="custom-control-label" htmlFor="contract">Contract Base</Label>
                                                </div>
                                            </FormGroup>
                                            ...
                                            <FormGroup className="mb-2">
                                                <div className="custom-control custom-checkbox">
                                                    ...
                                                    <Label className="custom-control-label" htmlFor="freelancer">Freelancer</Label>
                                                </div>
                                            </FormGroup>
                                            ...
                                            <FormGroup className="mb-2">
                                                <div className="custom-control custom-checkbox">
                                                    ...
                                                    <Label className="custom-control-label" htmlFor="remote">Remote</Label>
                                                </div>
                                            </FormGroup>
                                            ...
                                            <FormGroup className="mb-0">
                                                <div className="custom-control custom-checkbox">
                                                    ...
                                                    <Label className="custom-control-label" htmlFor="intership">Intership</Label>
                                                </div>
                                            </FormGroup>
                                        </div>
                                    </div>
                                        ...
                                        <div className="mt-4">
                                            <div className="custom-control custom-radio">
                                                <FormGroup className="mb-2">
                                                    ...
                                                    <Label className="custom-control-label" htmlFor="freshers">Fresher</Label>
                                                </FormGroup>
                                            </div>
                                            ...
                                            <div className="custom-control custom-radio">
                                                <FormGroup className="mb-2">
                                                    ...
                                                    <Label className="custom-control-label" htmlFor="oneyearex">+1 Year</Label>
                                                </FormGroup>
                                            </div>
                                            ...
                                            <div className="custom-control custom-radio">
                                                <FormGroup className="mb-2">
                                                    ...
                                                    <Label className="custom-control-label" htmlFor="twoyearex">+2 Year</Label>
                                                </FormGroup>
                                            </div>
                                            ...
                                            <div className="custom-control custom-radio">
                                                <FormGroup className="mb-2">
                                                    ...
                                                    <Label className="custom-control-label" htmlFor="threeyearex">+3 Year</Label>
                                                </FormGroup>
                                            </div>
                                            ...
                                            <div className="custom-control custom-radio">
                                                <FormGroup className="mb-0">
                                                    ...
                                                    <Label className="custom-control-label" htmlFor="fiveyearex">+5 Year</Label>
                                                </FormGroup>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <Card className="job-box rounded shadow border-0 overflow-hidden">
                                        ...
                                        <CardBody className="content position-relative">
                                            ...
                                            <div className="company-detail text-center mt-3">
                                                ...
                                                <p className="text-muted"><Link to="#" className="video-play-icon text-muted"><i><FeatherIcon icon="map-pin" className="fea icon-sm" /></i> San Francisco</Link></p>
                                            </div>
                                            <ul className="job-facts list-unstyled">
                                                <li className="list-inline-item text-muted"><i><FeatherIcon icon="check" className="fea icon-sm text-success mr-1" /></i> {job.Experience} Expirence</li>
                                                <li className="list-inline-item text-muted"><i><FeatherIcon icon="check" className="fea icon-sm text-success mr-1" /></i> Working Hours- {job.workingHrs}</li>
                                                <li className="list-inline-item text-muted"><i><FeatherIcon icon="check" className="fea icon-sm text-success mr-1" /></i> {job.field}</li>
                                            </ul>
