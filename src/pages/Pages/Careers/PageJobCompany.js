...
class PageJobCompany extends Component {
    constructor(props) {
        ...
        this.state = {
            jobs : [
                { title : "Senior Web Developer", icon : "monitor", location : "London, UK" },
                { title : "Front-End Developer", icon : "airplay", location : "Brasilia, Brazil" },
                { title : "Back-End Developer", icon : "cpu", location : "Ottawa, Canada" },
    ...
    render() {
        return (
            <React.Fragment>
                <section className="bg-half-260 d-table w-100" style={{background: `url(${imgbg}) center center`}}>
                                ...
                                <div className="job-profile position-relative">
                                    <div className="rounded shadow bg-white">
                                        <div className="text-center py-5 border-bottom">
                                            <img src={profile} className="avatar avatar-medium mx-auto rounded-circle d-block" alt=""/>
                                        ...
                                        <div className="p-4">
                                            ...
                                            <ul className="list-unstyled feature-list mb-4">
                                                <li className="h6"><i><FeatherIcon icon="map-pin" className="fea icon-sm text-warning mr-2" /></i><span className="text-muted">Location :</span> San Francisco</li>
                                                <li className="h6"><i><FeatherIcon icon="link" className="fea icon-sm text-warning mr-2" /></i><span className="text-muted">Comapny :</span> circleci.com</li>
                                                <li className="h6"><i><FeatherIcon icon="dollar-sign" className="fea icon-sm text-warning mr-2" /></i><span className="text-muted">Revenue :</span> $ 5M / Annual</li>
                                                <li className="h6"><i><FeatherIcon icon="users" className="fea icon-sm text-warning mr-2" /></i><span className="text-muted">No. of employees :</span> 200</li>
                                            </ul>
                                                    ...
                                                    <Link to="/page-job-detail" className="text-dark">
                                                        <div className="key-feature d-flex align-items-center p-3 bg-white rounded shadow">
                                                            <div className="icon text-center rounded-circle mr-3">
                                                                <i><FeatherIcon icon={job.icon} className="fea icon-ex-md text-primary" /></i>
                                                            </div>
