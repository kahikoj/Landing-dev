            ...
            <React.Fragment>
                ...
                <section className="bg-home bg-animation-left dark-left d-flex align-items-center" style={{ backgroundImage: `url(${comingsoon})`}} id="home">
                    ...
                    <Container className="position-relative text-md-left text-center" style={{zIndex:1}}>
                        <Row>
                            <Col md="12">
                                <Link to="#" className="logo h5"><img src={logolight} height="24" alt=""/></Link>
                        ...
                        <Row>
                            <Col md="12">  
                                ...
                                <Link to="/index" className="btn btn-outline-primary mt-4 ml-1"><i className="mdi mdi-backup-restore"></i> Go Back Home</Link>
                            </Col>
                        </Row>
                    </Container>
                </section>
