...
class PageBlogListSidebar extends Component {
    constructor(props) {
        ...
        this.state={
            ...
            blogs : [
                { id : 1, image : blog14, title : "Design your apps in your own way", desc : "Due to its widespread use as filler text for layouts, non-readability", like : "33", comment : "08", autor : "Calvin Carlo", date : "13th August, 2019" },
                { id : 2, image : blog15, title : "How apps is changing the IT world", desc : "Due to its widespread use as filler text for layouts, non-readability", like : "33", comment : "08", autor : "Calvin Carlo", date : "13th August, 2019" },
                { id : 3, image : blog16, title : "Smartest Applications for Business", desc : "Due to its widespread use as filler text for layouts, non-readability", like : "33", comment : "08", autor : "Calvin Carlo", date : "13th August, 2019" },
                { id : 4, image : blog17, title : "Design your apps in your own way", desc : "Due to its widespread use as filler text for layouts, non-readability", like : "33", comment : "08", autor : "Calvin Carlo", date : "13th August, 2019" },
                { id : 5, image : blog18, title : "How apps is changing the IT world", desc : "Due to its widespread use as filler text for layouts, non-readability", like : "33", comment : "08", autor : "Calvin Carlo", date : "13th August, 2019" },
                { id : 6, image : blog19, title : "Smartest Applications for Business", desc : "Due to its widespread use as filler text for layouts, non-readability", like : "33", comment : "08", autor : "Calvin Carlo", date : "13th August, 2019" },
                { id : 7, image : blog13, title : "Design your apps in your own way", desc : "Due to its widespread use as filler text for layouts, non-readability", like : "33", comment : "08", autor : "Calvin Carlo", date : "13th August, 2019" },
            ]
        }
    }
    ...
    render() {
        return (
            <React.Fragment>
                {/* breadcrumb */}
                <PageBreadcrumb title="Blog Listing & Sidebar" pathItems = {this.state.pathItems} />
