...
class EmailInvoice extends Component {
    componentDidMount(){
        ...
        document.getElementById("invTable").style.setProperty('overflow-x', "auto", 'important');
    }
        ...
        <section style={{alignItems: "center", padding: "150px 0"}}>
            <Container>
                <Row style={{justifyContent: "center"}}>
                    <Col lg={6} md={8}> 
                        <table style={{boxSizing: "border-box", width: "100%", borderRadius: "6px", overflow: "hidden", backgroundColor: "#fff", boxShadow: "0 0 3px rgba(60, 72, 88, 0.15)"}}>
                            <thead>
                                <tr style={{backgroundColor: "#2f55d4", padding: "3px 0", lineHeight: "68px", textAlign: "center", color: "#fff", fontSize: "24px", fontWeight: "700", letterSpacing: "1px" }}>
                                    <th scope="col"><img src={logo} height="24" alt="Landrick" /></th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style={{padding: "24px"}}>
                                        <div id="invTable" style={{display: "block", width: "100%", borderRadius: "6px", boxShadow: "0 0 3px rgba(60, 72, 88, 0.15)"}}>
                                            <table style={{width: "100%"}}>
                                                <thead className="bg-light">
                                                    <tr>
                                                        <th scope="col" style={{textAlign: "left", verticalAlign: "bottom", borderTop: "1px solid #dee2e6", padding: "12px"}}>No.</th>
                                                        <th scope="col" style={{textAlign: "left", verticalAlign: "bottom", borderTop: "1px solid #dee2e6", padding: "12px"}} >Item</th>
