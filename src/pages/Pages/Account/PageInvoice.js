                                    ...
                                    <div className="invoice-top pb-4 border-bottom">
                                        <Row>
                                            <Col md="8">
                                                ...
                                                <Link to="#" className="text-primary h6"><i><FeatherIcon icon="link" className="fea icon-sm text-muted mr-2" /></i>www.landrick.corp</Link>
                                            </Col>

                                            <Col md="4" className="mt-4 mt-sm-0">
                                                <h5>Address :</h5>
                                                <dl className="row mb-0">
                                                    <dt className="col-2 text-muted"><i><FeatherIcon icon="map-pin" className="fea icon-sm" /></i></dt>
                                                    ...
                                                    <dt className="col-2 text-muted"><i><FeatherIcon icon="mail" className="fea icon-sm" /></i></dt>
                                                    <dd className="col-10 text-muted">
                                                        <Link to="#" id="mail" onClick={this.sendMail} className="text-muted">info@landrick.com</Link>
                                                    </dd>

                                                    <dt className="col-2 text-muted"><i><FeatherIcon icon="phone" className="fea icon-sm" /></i></dt>
                                                    <dd className="col-10 text-muted">
                                                ...
                                                <tbody>
                                                    {
                                                        this.state.items.map((item,key) =>
                                                            <tr key={key}>
                                                                <th scope="row" className="text-left">{key+1}</th>
