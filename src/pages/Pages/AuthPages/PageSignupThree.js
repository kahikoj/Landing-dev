                                    ...
                                    <Row>
                                        <Col md={6}>
                                            <FormGroup className="position-relative">                                               
                                                ...
                                                validate={{ required: { value: true } }} placeholder="First Name" name="fname" />
                                            </FormGroup>
                                        </Col>
                                        <Col md={6}>
                                            <FormGroup className="position-relative">                                                
                                                ...
                                                validate={{ required: { value: true } }} placeholder="Last Name" name="lname" />
                                            </FormGroup>
                                        </Col>
                                        <Col md={12}>
                                            <FormGroup className="position-relative">
                                        ...
                                        <Col md={12}>
                                            <FormGroup className="position-relative">
                                                ...
                                                errorMessage="Enter Last Name"
                                                validate={{ required: { value: true } }} name="password" placeholder="Password" />
                                            </FormGroup>
                                        </Col>
                                        <Col md={12}>
                                            <FormGroup className="position-relative">
