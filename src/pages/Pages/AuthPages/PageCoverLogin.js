                ...
                <section className="cover-user bg-white">
                    <Container fluid className="px-0">
                        <Row className="no-gutters position-relative">
                                                ...
                                                <AvForm className="llogin-form mt-4">
                                                    <Row>
                                                        ...
                                                        <Col lg="12">
                                                            ...
                                                            <p className="float-right forgot-pass"><Link to="auth-cover-re-password" className="text-dark font-weight-bold">Forgot password ?</Link></p>
                            ...
                            <Col lg={{size:8, offset:4}} xs={{order:1}} className="padding-less img " style={{ backgroundImage: `url(${user01})` }}></Col>
                        </Row>
                    </Container>
                </section>
            </React.Fragment>
