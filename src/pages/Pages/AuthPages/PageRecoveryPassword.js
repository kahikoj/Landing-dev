                                    ...
                                    <AvForm className="login-form mt-4">
                                        <Row>
                                            ...
                                            <div className="mx-auto">
                                                <p className="mb-0 mt-3"><small className="text-dark mr-2">Remember your password ?</small> <Link to="auth-login" className="text-dark font-weight-bold">Sign in</Link></p>
                                            </div>
                                        </Row>
                                    </AvForm>
                                    </CardBody>
