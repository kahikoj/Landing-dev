                                    ...
                                    <Row>
                                        <Col lg={12}>
                                            <FormGroup className="position-relative">
                                                ...
                                                <AvField type="email" className="form-control pl-5" errorMessage="Invalid Email"
                                                    validate={{
                                                    required: { value: true },
                                                    email: { value: true }
                                        ...
                                        <Col lg={12}>
                                            <FormGroup className="position-relative">
                                                ...
                                                <AvField type="password" className="form-control pl-5" name="password"
                                                errorMessage="Enter password"
                                                validate={{ required: { value: true } }} placeholder="Password"/>
                                            </FormGroup>
                                        </Col>
                                        ...
                                        <Col lg={12}>
                                            <div className="d-flex justify-content-between">
                                                ...
                                                <p className="forgot-pass mb-0"><Link to="auth-re-password-three" className="text-dark font-weight-bold">Forgot password ?</Link></p>
                                            </div>
                                        </Col>
                                        ...
                                        <Col xs={12} className="text-center">
                                            <p className="mb-0 mt-3"><small className="text-dark mr-2">Don't have an account ?</small> <Link to="auth-signup-three" className="text-dark font-weight-bold">Sign Up</Link></p>
                                        </Col>
                                    </Row>
                                </AvForm>
                            </CardBody>
