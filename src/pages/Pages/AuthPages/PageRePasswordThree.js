                                ...
                                <AvForm className="login-form mt-4">
                                    <Row>
                                        <Col lg={12}>
                                            ...
                                            <FormGroup className="position-relative">
                                                ...
                                                <AvField
                                                    ...
                                                    type="email" className="form-control pl-5" placeholder="Enter Your Email Address" />
                                            </FormGroup>
                                        </Col>
                                        <Col lg={12}>
                                        ...
                                        <div className="mx-auto">
                                            <p className="mb-0 mt-3"><small className="text-dark mr-2">Remember your password ?</small> <Link to="auth-login-three" className="text-dark font-weight-bold">Sign in</Link></p>
                                        </div>
                                    </Row>
                                </AvForm>
                            </CardBody>
