                                                    ...
                                                    <Col md="12">
                                                        <FormGroup>
                                                            <div className="custom-control custom-checkbox">
                                                                <Input type="checkbox" className="custom-control-input" id="user-check1"/>
                                                                <Label className="custom-control-label" for="user-check1">I Accept <Link to="#" className="text-primary">Terms And Condition</Link></Label>
                                                            </div>
                                                        </FormGroup>
                                                    </Col>
                                                    <Col md="12">
                            ...
                            <Col lg={{size:7, offset:1}} md={{size:7, order:2}} xs={{order:1}}>
                                <div className="title-heading mt-4">
                                    ...
                                    <div className="mt-4 pt-2">
                                        ...
                                        <Link to="" className="btn btn-outline-primary mt-2 ml-1"><i className="mdi mdi-google-play"></i> Play Store</Link>
                                    </div>
                                </div>
                            </Col>
                        </Row>
