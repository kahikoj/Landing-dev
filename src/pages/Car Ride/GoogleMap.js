...
import { Container, Row, Col, Form, FormGroup, Label, Input, Card, CardBody } from 'reactstrap';
                                        ...
                                        <Row>
                                            <Col md="12">
                                                <FormGroup className="position-relative">
                                                    ...
                                                    <i><FeatherIcon icon="map-pin" className="fea icon-sm icons text-success" /></i>
                                            ...
                                            <Col md="12">
                                                <FormGroup className="position-relative">
                                                    ...
                                                    <i><FeatherIcon icon="map-pin" className="fea icon-sm icons text-danger" /></i>
